...
Use this skill when processing alerts from `https://github.com/synapsion/openclaw/security/secret-scanning`.
...
[
  {
    ...
    "location_url": "https://github.com/synapsion/openclaw/issues/63101#issuecomment-xxx",
