...
export const ko: TranslationMap = {
  ...
  agents: {
    noAgents: "에이전트 없음",
    copyId: "ID 복사",
    copyIdTitle: "에이전트 ID를 클립보드에 복사",
    default: "기본",
    setDefault: "기본으로 설정",
    alreadyDefaultTitle: "이미 기본 에이전트입니다",
    setDefaultTitle: "기본 에이전트로 설정",
    selectTitle: "에이전트 선택",
    selectSubtitle: "워크스페이스와 도구를 검사할 에이전트를 선택하세요.",
    tabs: {
      overview: "개요",
      files: "파일",
      tools: "도구",
    ...
    context: {
      title: "에이전트 컨텍스트",
      workspace: "워크스페이스",
      openFilesTab: "열린 파일 탭",
      primaryModel: "주요 모델",
      runtime: "런타임",
      identityName: "식별 이름",
      identityAvatar: "식별 아바타",
      skillsFilter: "스킬 필터",
      default: "기본",
      configurationSubtitle: "워크스페이스, 식별 및 모델 구성.",
      schedulingSubtitle: "워크스페이스 및 예약 대상.",
    },
    channels: {
      title: "채널",
      subtitle: "Gateway의 채널 상태 스냅샷입니다.",
      lastRefresh: "마지막 새로고침: {time}",
      loadHint: "실시간 상태를 보려면 채널을 로드하세요.",
      empty: "채널을 찾을 수 없습니다.",
      connectedCount: "{connected}/{total} 연결됨",
      noAccounts: "계정 없음",
      configuredCount: "{count} 구성됨",
      notConfigured: "구성되지 않음",
      enabledCount: "{count} 사용 중",
      setupGuide: "설치 가이드",
    },
    cronPanel: {
      schedulerTitle: "스케줄러",
      schedulerSubtitle: "Gateway의 cron 상태입니다.",
      jobs: "작업",
      nextWake: "다음 실행",
      agentJobsTitle: "에이전트 Cron 작업",
      agentJobsSubtitle: "이 에이전트를 대상으로 예약된 작업입니다.",
      noJobs: "할당된 작업이 없습니다.",
      runNow: "지금 실행",
    },
    files: {
      ...
      extensionPreview: "{ext} 미리보기",
      preview: "미리보기",
      expandPreview: "미리보기 확장",
      collapsePreview: "미리보기 축소",
      editFile: "파일 편집",
      closePreview: "미리보기 닫기",
      coreFilesTitle: "핵심 파일",
      coreFilesSubtitle: "페르소나, 식별 및 도구 안내 초기 설정.",
      workspace: "워크스페이스",
      loadHint: "핵심 지침을 편집하려면 에이전트 워크스페이스 파일을 로드하세요.",
      empty: "파일을 찾을 수 없습니다.",
      missing: "누락",
      selectFile: "편집할 파일을 선택하세요.",
      previewMarkdownTitle: "렌더된 마크다운 미리보기",
      willCreateOnSave: "저장 시 생성됨",
      liveDraftPreview: "실시간 초안 미리보기",
      savedPreview: "저장된 미리보기",
      updated: "업데이트됨 {time}",
      notCreatedYet: "아직 생성되지 않음",
      updatedUnknown: "업데이트됨(알 수 없음)",
      missingHint: "이 파일이 없습니다. 저장하면 에이전트 워크스페이스에 생성됩니다.",
      content: "내용",
      words: "{count}단어",
      lines: "줄",
    },
  ...
  debug: {
    snapshotsTitle: "스냅샷",
    snapshotsSubtitle: "상태, 헬스, 하트비트 데이터",
    status: "상태",
    health: "헬스",
    lastHeartbeat: "마지막 하트비트",
    security: {
      audit: "보안 감사",
      critical: "{count}건 치명적",
      warnings: "{count}건 경고",
      noCriticalIssues: "치명적 문제 없음",
      info: "{count}건 정보",
      runPrefix: "실행",
      runSuffix: "자세히 보기",
    },
    manualRpcTitle: "수동 RPC",
    manualRpcSubtitle: "JSON 매개변수로 원시 gateway 메서드를 전송합니다.",
    method: "메서드",
    selectMethod: "메서드 선택…",
    paramsJson: "매개변수 (JSON)",
    modelsTitle: "모델",
    modelsSubtitle: "models.list에서 제공되는 카탈로그.",
    eventLogTitle: "이벤트 로그",
    eventLogSubtitle: "최신 Gateway 이벤트.",
    noEvents: "아직 이벤트가 없습니다.",
  },
  execApproval: {
    expiresIn: "만료까지 {time}",
    expired: "만료됨",
    execApprovalNeeded: "실행 승인 필요",
  ...
  dreaming: {
    ...
    restartConfirmation: {
      title: "변경 사항 적용을 위해 Gateway 재시작",
      subtitle: "Dreaming 모드를 변경하면 Gateway가 재시작됩니다.",
      warning:
        "이 작업은 Gateway를 재시작하며 채팅, 자동화 및 연결된 채널이 일시적으로 중단될 수 있습니다.",
      confirm: "재시작 확인",
      restarting: "재시작 중…",
      failed: "변경을 적용하지 못했습니다. 연결을 확인하고 다시 시도하세요.",
    },
    status: {
      active: "드리밍 활성",
      idle: "드리밍 유휴",
